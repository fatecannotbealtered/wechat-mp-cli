...
var commandOutputSchemas = map[string]string{
	...
	"menu addconditional": "menu_conditional",
	// qrcode
	"qrcode create": "qrcode_create",
	// user
	"user info":       "user_info",
	"user list":       "user_list",
	"user info-batch": "user_info_batch",
	// message mass (broadcast)
	"message mass sendall": "mass_send_job",
	"message mass send":    "mass_send_job",
	"message mass preview": "mass_preview",
	"message mass get":     "mass_status",
	"message mass delete":  "mass_delete",
	// tag
	"tag get":       "tag_list",
	"tag create":    "tag_create",
	"tag update":    "tag_action",
	"tag delete":    "tag_delete",
	"tag members":   "tag_members",
	"tag tagging":   "tag_batch",
	"tag untagging": "tag_batch",
	// publish
...
var commandExamples = map[string][]string{
	...
	"menu addconditional":                 {"wechat-mp-cli menu addconditional --file ./conditional-menu.json --dry-run --dangerous --compact", "wechat-mp-cli menu addconditional --file ./conditional-menu.json --confirm <confirm_token> --dangerous --compact"},
	"qrcode create":                       {"wechat-mp-cli qrcode create --expire-seconds 604800 --scene-str promo-001 --dry-run --compact", "wechat-mp-cli qrcode create --scene-id 123 --confirm <confirm_token> --compact"},
	"user info":                           {"wechat-mp-cli user info <openid> --lang zh_CN --compact"},
	"user list":                           {"wechat-mp-cli user list --next-openid <openid> --compact"},
	"user info-batch":                     {"wechat-mp-cli user info-batch --openids <openid1>,<openid2> --openids <openid3> --lang zh_CN --compact"},
	"message mass sendall":                {"wechat-mp-cli message mass sendall --to-all --mpnews-media-id <media_id> --dry-run --dangerous --compact", "wechat-mp-cli message mass sendall --to-all --mpnews-media-id <media_id> --confirm <confirm_token> --dangerous --compact"},
	"message mass send":                   {"wechat-mp-cli message mass send --openids <openid1>,<openid2> --mpnews-media-id <media_id> --dry-run --dangerous --compact", "wechat-mp-cli message mass send --openids <openid1>,<openid2> --mpnews-media-id <media_id> --confirm <confirm_token> --dangerous --compact"},
	"message mass preview":                {"wechat-mp-cli message mass preview --openid <openid> --mpnews-media-id <media_id> --dry-run --dangerous --compact", "wechat-mp-cli message mass preview --openid <openid> --mpnews-media-id <media_id> --confirm <confirm_token> --dangerous --compact"},
	"message mass get":                    {"wechat-mp-cli message mass get --msg-id 2247483647 --compact"},
	"message mass delete":                 {"wechat-mp-cli message mass delete --msg-id 2247483647 --dry-run --dangerous --compact", "wechat-mp-cli message mass delete --msg-id 2247483647 --confirm <confirm_token> --dangerous --compact"},
	"tag get":                             {"wechat-mp-cli tag get --compact"},
	"tag create":                          {"wechat-mp-cli tag create --name VIP --dry-run --compact", "wechat-mp-cli tag create --name VIP --confirm <confirm_token> --compact"},
	"tag update":                          {"wechat-mp-cli tag update --id 100 --name VIP2 --dry-run --compact", "wechat-mp-cli tag update --id 100 --name VIP2 --confirm <confirm_token> --compact"},
	"tag delete":                          {"wechat-mp-cli tag delete --id 100 --dry-run --dangerous --compact", "wechat-mp-cli tag delete --id 100 --confirm <confirm_token> --dangerous --compact"},
	"tag members":                         {"wechat-mp-cli tag members <tagid> --next-openid <openid> --compact"},
	"tag tagging":                         {"wechat-mp-cli tag tagging --id 100 --openid <openid> --dry-run --compact", "wechat-mp-cli tag tagging --id 100 --openid <openid> --confirm <confirm_token> --compact"},
	"tag untagging":                       {"wechat-mp-cli tag untagging --id 100 --openid <openid> --dry-run --compact", "wechat-mp-cli tag untagging --id 100 --openid <openid> --confirm <confirm_token> --compact"},
...
func referenceSchemas() map[string]referenceDataSchema {
	return map[string]referenceDataSchema{
		...
		"menu_conditional":  {Shape: "object", Fields: []string{"account", "menuid", "errcode", "errmsg"}},
		"qrcode_create":     {Shape: "object", Fields: []string{"account", "action_name", "ticket", "expire_seconds", "url", "showqrcode_url", "errcode", "errmsg"}},
		"user_info":         {Shape: "object", Fields: []string{"account", "openid", "subscribe", "subscribe_time", "nickname", "remark", "tagid_list", "_untrusted", "errcode", "errmsg"}, UntrustedFields: []string{"nickname", "remark"}},
		"user_list":         {Shape: "object", Fields: []string{"account", "total", "count", "data", "next_openid", "errcode", "errmsg"}},
		// Batch result (CLI-SPEC §15.5/§15.8): per-item items[] keyed by openid
		// target, plus a total/succeeded/failed summary. The profile bodies inside
		// items carry WeChat-controlled nickname/remark, so items is _untrusted.
		"user_info_batch": {Shape: "object", Fields: []string{"account", "items", "summary", "_untrusted"}, UntrustedFields: []string{"items"}},
		// Mass-send job: one asynchronous broadcast returns a msg_id to poll, not
		// per-recipient items (a mass send is a single upstream job, not atomic).
		"mass_send_job":      {Shape: "object", Fields: []string{"account", "audience", "total", "msg_id", "msg_data_id", "errcode", "errmsg", "status_hint"}},
		"mass_preview":       {Shape: "object", Fields: []string{"account", "msg_id", "errcode", "errmsg"}},
		"mass_status":        {Shape: "object", Fields: []string{"account", "msg_id", "msg_status", "errcode", "errmsg"}},
		"mass_delete":        {Shape: "object", Fields: []string{"account", "msg_id", "errcode", "errmsg"}},
		"tag_list":           {Shape: "object", Fields: []string{"account", "tags", "_untrusted", "errcode", "errmsg"}, UntrustedFields: []string{"tags"}},
		"tag_create":         {Shape: "object", Fields: []string{"account", "tag", "_untrusted", "errcode", "errmsg"}, UntrustedFields: []string{"tag"}},
		"tag_action":         {Shape: "object", Fields: []string{"account", "errcode", "errmsg"}},
		"tag_delete":         {Shape: "object", Fields: []string{"account", "deleted_tag_id", "errcode", "errmsg"}},
		"tag_members":        {Shape: "object", Fields: []string{"account", "tagid", "count", "data", "next_openid", "errcode", "errmsg"}},
		"tag_batch":          {Shape: "object", Fields: []string{"account", "tagid", "openid_count", "errcode", "errmsg"}},
